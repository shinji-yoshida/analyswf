...
describe Replacement::SwfParameter do
  ...
  describe 'decode_params' do
    before do
      ...
      @actuals = Replacement::SwfParameter.decode_params(params)
    end
